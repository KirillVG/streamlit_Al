...
def app():
    ...
    #Подписи значений
    text_1 = bar_1.mark_text(align='center',baseline='middle',dy=-10,color="red").encode(text='volume:Q')
    #Посуточный план
    ...
    #Подписи значений
    text_2 = bar_2.mark_text(align='center',baseline='middle',dy=-10,color="red").encode(text='volume:Q')
